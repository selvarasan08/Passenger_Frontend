...
import { Bus, QrCode, User, Clock, AlertCircle, Zap, MapPin } from 'lucide-react';
import './App.css';

const API_URL =
  process.env.REACT_APP_API_URL ||
  'https://trackease-backend-teq8.onrender.com/api/bus';
        ...
        >
          ...
          {trackingBusId ? (
            <div
              style={{
                background:
                  'linear-gradient(to right, #16a34a, #15803d, #166534)',
                color: 'white',
                padding: '1.5rem'
              }}
            >
              <div className="flex items-center justify-between">
                ...
                {busData && (
                  <div
                    ...
                    style={{ fontSize: '0.875rem', flexWrap: 'wrap' }}
                  >
